        ...
        <div style={{display:"flex", flexDirection:"column", justifyContent:"space-between", height:"100%"}}>
            ...
            <form className={styles.registerForm}  onSubmit={registerUser}>
                ...
                <div className={styles.formInput}>
                    ...
                    <input disabled={loading} type="password" value={passwordAgain} onChange={e => setPasswordAgain(e.currentTarget.value)}  placeholder='Mật khẩu' name='password' required className={styles.inputPhone} />
