        ...
        <div className={styles.depositCard}>
          ...
          <div>
            ...
            <div className={styles.inputItem}>
              ...
              <input value={amount} onChange={e => onDepositAmountChange(e.target.value)} type="number" className={styles.whiteInput} />
              {amount && <IconButton size='small' onClick={() => { setAmount(""); }}>{<AiOutlineCloseCircle style={{ color: 'white', fontSize:'20px' }} />}</IconButton>}
            </div>
            {/*amount error*/}
          ...
          <div className={styles.circleTextOverlay}>
            {amount && <p style={{ fontSize: '0.85rem', color: '#F7DB89', flexGrow: 1, textAlign:'left' }}>
